...
export const metadata: Metadata = {
  title: 'Javari Orlando',
  description: 'Best Orlando theme park deals — Disney, Universal, SeaWorld tickets via real affiliate links.',
  keywords: ['Javari AI', 'CR AudioViz AI', 'Javari Orlando', 'artificial intelligence'],
      ...
      <body style={{ margin: 0, padding: 0, fontFamily: 'system-ui, sans-serif' }}>
        ...
        <div style={{ background: 'rgba(0,0,0,0.85)', backdropFilter: 'blur(8px)', padding: '6px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'relative', zIndex: 200 }}>
          <a href="https://craudiovizai.com" style={{ display: 'flex', alignItems: 'center', gap: 8, textDecoration: 'none', color: '#fff', fontSize: 13, fontWeight: 600, opacity: 0.85 }}>
            <span>🏰</span>
            <span style={{ color: '#f59e0b' }}>Javari Orlando</span>
            <span style={{ color: '#6b7280', fontSize: 11, marginLeft: 4 }}>by CR AudioViz AI · EIN 39-3646201</span>
          </a>
          <a href="https://craudiovizai.com/auth/signup" style={{ background: '#f59e0b', color: '#000', borderRadius: 6, padding: '4px 14px', fontSize: 12, fontWeight: 700, textDecoration: 'none', whiteSpace: 'nowrap' }}>
            Real Deals →
          </a>
        </div>
        {children}
